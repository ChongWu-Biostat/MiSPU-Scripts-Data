...
setwd("/panfs/roc/groups/1/panwei/wuxx0845/swak/sim20/")
library(xtable)
plot.res = matrix(NA,9,11)
...
final.res = final.res/out.i
final.res
plot.res[,8] = c(final.res[2,1],final.res[2,2],final.res[2,5],final.res[2,6],final.res[7,1],final.res[7,9],final.res[8,9],final.res[9,1],final.res[4,1])
...
for (i in 1:1000)
{
    ...
    file.name = paste("final8Res",index,".txt",sep="")
...
final.res = final.res/out.i
final.res
plot.res[,9] = c(final.res[2,1],final.res[2,2],final.res[2,5],final.res[2,6],final.res[7,1],final.res[7,9],final.res[8,9],final.res[9,1],final.res[4,1])
...
for (i in 1:1000)
{
    ...
    file.name = paste("final9Res",index,".txt",sep="")
...
final.res = final.res/out.i
final.res
plot.res[,10] = c(final.res[2,1],final.res[2,2],final.res[2,5],final.res[2,6],final.res[7,1],final.res[7,9],final.res[8,9],final.res[9,1],final.res[4,1])
...
for (i in 1:1000)
{
    ...
    file.name = paste("final10Res",index,".txt",sep="")
...
final.res = final.res/out.i
final.res
plot.res[,11] = c(final.res[2,1],final.res[2,2],final.res[2,5],final.res[2,6],final.res[7,1],final.res[7,9],final.res[8,9],final.res[9,1],final.res[4,1])



##
library(ggplot2)
res = as.data.frame(matrix(NA,9*11,3))
colnames(res) = c("power","x","Methods")
res[,1] = c(plot.res)
res[,2] = rep(c(0,0.5,1,2,3,4,5,7,10,15,20),each  = 9)
res[,3] = factor(rep(1:9,times = 11),levels =  1:9)

setwd("/panfs/roc/groups/1/panwei/wuxx0845/swak/results/")
write.table(res,"sim20.txt",sep=",")
