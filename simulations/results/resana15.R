...
setwd("/panfs/roc/groups/1/panwei/wuxx0845/swak/sim15/")
library(xtable)
...
final.res
plot.res[,1] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
rownames(plot.res) = c("Ku","K5","Kw","Kopt","aMiSPUw","MiSPUu2","aMiSPUuinf","aMiSPUu","aMiSPU")
...
final.res = final.res/out.i
final.res
plot.res[,2] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
...
plot.res[,3] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
...
final.res = final.res/out.i
final.res
plot.res[,4] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
...
final.res = final.res/out.i
final.res
plot.res[,5] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
...
final.res = final.res/out.i
final.res
plot.res[,6] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
...
final.res = final.res/out.i
final.res
plot.res[,7] = c(final.res[2,2],final.res[2,4],final.res[2,5],final.res[2,6],final.res[7,9],final.res[8,1],final.res[8,8],final.res[8,9],final.res[9,1])
...
res[,3] = factor(rep(c("Ku","K5","Kw","Kopt","aMiSPUw","MiSPUu2","aMiSPUuinf","aMiSPUu","aMiSPU"),times = 7),levels =  c("Ku","K5","Kw","Kopt","aMiSPUw","MiSPUu2","aMiSPUuinf","aMiSPUu","aMiSPU"))

setwd("/panfs/roc/groups/1/panwei/wuxx0845/swak/results/")
write.table(res,"sim15.txt",sep=",")
